...
GetRandomMapRotation(random, current, number)
{
	...
	// all the maps :D
	maprot = "map mp_brecourt map mp_carentan map mp_chateau map mp_dawnville map mp_depot map mp_harbor map mp_hurtgen map mp_pavlov map mp_powcamp map mp_railyard map mp_rocket map mp_ship";
